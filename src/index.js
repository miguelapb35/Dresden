  ...
  return (
    <>
      <Block factor={1} offset={0}>
        ...
        <Block factor={1.0}>
          <Dom position={[-w / 3.2, -w * 0.08 + 0.25, -1]}>DIE FLORENZ{mobile ? <br /> : " "}  VON ELBA</Dom>
        </Block>
      </Block>
      <Block factor={1.2} offset={5.7}>
        {/* <MultilineText top left size={w * 0.15} lineHeight={w / 5} position={[-w / 3.5, 0, -1]} color="#2fe8c3" text={"Altstadt\nzero\nzero"} /> */}
        <MultilineText top left size={w * 0.15} lineHeight={w / 5} position={[-w / 3.5, 0, -1]} color="#2fe8c3" text={"Altstadt"} />
      </Block>
  ...
  return (
    ...
    {/*    <h1 className="frame__title">Scroll, Refraction and Shader Effects</h1>
        ...
        <div className="frame__nav">
          ...
          <a className="frame__link" href="#08" children="08" />
        </div>
      </div>
    </>
  )
